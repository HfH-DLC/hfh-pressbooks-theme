...
<section class="book-header">
	<div class="book-header__inner">
		<div class="book-header__columns">
		<div class="book-header__column book-header__md">
			...
			<?php if ( ! empty( $book_information['pb_cover_image'] ) ) { ?>
				<div class="book-header__cover__image">
					...
					if ( $cover_id ) {
						...
						echo wp_get_attachment_image( $cover_id, array( 333, 500 ), false, array( 'alt' => sprintf( __( 'Cover image for %s', 'pressbooks-book' ), get_bloginfo( 'name' ) ) ) );
					} else {
						echo sprintf(
							'<img src="%1$s" alt="%2$s" />',
		...
		<div class="book-header__cta">
			...
			if ( array_filter( get_option( 'pressbooks_ecommerce_links', array() ) ) ) {
				?>
